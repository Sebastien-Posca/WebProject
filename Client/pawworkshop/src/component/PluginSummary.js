...
import { Tabs, Tag, Avatar, Comment, Tooltip, Button, Icon, message } from 'antd';
                ...
                <>
                    <div className="pluginCard">
                        ...
                        <div className="pluginSideNotes">
                            ...
                            <Button type="primary" icon="download"><a className="downloadLink" href={`${BACKEND_ROOT_PATH}/submit/${fetchedPlugin._id}`}>Telecharger le plugin</a></Button>

                            <div>
                                {fetchedPlugin.likes < 1 ?
                                    <Icon className="cardIcons" style={{ fontSize: '30px' }} type="heart" theme="twoTone" twoToneColor="#eb2f96" onClick={handleLike} /> :
