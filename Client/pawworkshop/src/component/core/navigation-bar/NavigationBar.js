...
import { Menu, Icon, Button, Popover, Modal } from 'antd';
    ...
    return (
        <div className="navigationBar">
            ...
            <div className="navigationBarProfil" onClick={showSignIn}>
                <p>Se connecter</p>
                <Popover placement="bottomRight" content={<div className="popoverContent"><img className="popoverImageProfil" src="https://www.dictionary.com/e/wp-content/uploads/2018/03/PogChamp.jpg"></img> <p>Random Customer</p></div>} trigger="hover">
